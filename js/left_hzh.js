...
var hzh = {};
hzh.flag = 0;
hzh.divid = "ad_" + SINAADS_ARTICAL_AD_PDPS;
hzh.pdps = SINAADS_ARTICAL_AD_PDPS;
...
hzh.cssText = 'width:200px; height:300px; margin:10px 20px 10px 0px; float:left; overflow:hidden; clear:both; padding:4px; border:1px solid #CDCDCD; display:none;';
...
hzh.createHzh = function(){ //创建画中画广告容器（div标签）
	...
	oDiv.innerHTML = '<ins id="Sinaad_'+SINAADS_ARTICAL_AD_PDPS+'" class="sinaads" data-ad-pdps="'+hzh.pdps+'"></ins>';
    return oDiv;    
}
...
(sinaads = window.sinaads || []).push({
	element : document.getElementById('Sinaad_'+SINAADS_ARTICAL_AD_PDPS),
	params : {
