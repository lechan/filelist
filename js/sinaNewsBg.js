...
(function(){
  //加载素材
  this.data = ["bg.jpg","#","","no-repeat center 45px"];
  var pthis = this;//设置指针
...
this.init = function(){
  try{
   ...
   var fullScreenWrap = document.getElementById('wrap');
   ...
   //关闭按钮
   eval(o.initWrap(0x01,"div","cBtn","40","18","absolute","","1","","5","2","0","0","url(http://d1.sina.com.cn/shh/tianyi/bg/audi_zty_cls1.jpg) no-repeat right","block"));
   pthis.cBtn = cBtn;
