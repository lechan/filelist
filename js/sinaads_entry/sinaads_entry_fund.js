(function() {
	...
	//华安基金 begin
	sinaads_entry_fn("directAd_huaan_jj_01","huaan");
	sinaads_entry_fn("directAd_huaan_jj_02","huaan");
	sinaads_entry_fn("directAd_huaan_jj_03","huaan");
	sinaads_entry_fn("directAd_huaan_jj_04","huaan");
	sinaads_entry_fn("directAd_huaan_jj_05","huaan");
	sinaads_entry_fn("directAd_huaan_jj_06","huaan");
	//华安基金 end
})()